...
public class MealsUtil {
    ...
    public static Collection<MealTo> getTos(Collection<Meal> meals, int caloriesPerDay) {
        List<MealTo> mealToList = filterByPredicate(meals, caloriesPerDay, meal -> true);
        Collection<MealTo> mealToCollection = mealToList;
        return mealToCollection;
